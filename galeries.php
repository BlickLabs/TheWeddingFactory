...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Galerías Registradas</title>
...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
            ...
            <p>
            <center>
                <a href="create.php" class="btn btn-primary btn-md mar-topbtn"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Añadir Nueva Galería</a><br/>
            </center>
            ...
            <table id="ghatable" class="display table table-bordered table-stripe" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center">Nombre de la Galería</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td style="text-align: center"><?php echo $row['id_galery'] ?></td>
                            <td style="text-align: center"><?php echo $row['title_galery'] ?></td>
                            ...
                            <td >
                            <center>
                                <a class="btn btn-lg btn-success" href="update_register.php?u=<?php echo $row['id_galery'] ?>"><span class="glyphicon glyphicon-pencil" ></span> Editar</a>
                            </center>
                            </td> 
